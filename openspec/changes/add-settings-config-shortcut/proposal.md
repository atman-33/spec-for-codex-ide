...
## What Changes
- Add a `spec-codex-ide.settings.openConfig` command that resolves the OS-specific path to the global `.codex/config.toml` and opens it in the editor, surfacing a notification if the file is missing.
