...
- [ ] 1.2 Register the `spec-codex-ide.settings.openConfig` command to open the resolved config path in the editor, showing a VS Code notification if the file cannot be found or read.
